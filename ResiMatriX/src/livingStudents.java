 ...
 * @author Faizan Habib
 */
public class livingStudents extends javax.swing.JFrame {

    /**
     * Creates new form livingStudents
     */
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student Name", "Father Name", "Enrol No", "Course", "Batch", "Faculty", "Department", "Mobile No", "Address", "Room No", "Status"
            }
        ));
        jScrollPane1.setViewportView(table);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 48, 688, 440));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(livingStudents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
